...
!(function (t, e) {
    ...
    $ = (function (t) {
      function o(e, n) {
        ...
        return (
          ...
          (i._indicatorsElement = Y.findOne(
            ".carousel-indicators",
            i._element
          )),
          (i._touchSupported =
      ...
      return (
        ...
        (r._setActiveIndicatorElement = function (t) {
          if (this._indicatorsElement) {
            for (
              var e = Y.find(".active", this._indicatorsElement), n = 0;
              n < e.length;
              n++
            )
  ...
  B.on(
    ...
    B.on(window, "load.bs.carousel.data-api", function () {
      for (
        var t = Y.find('[data-bs-ride="carousel"]'), e = 0, n = t.length;
        e < n;
        e++
      )
  ...
  var G = "collapse",
    ...
    tt = (function (t) {
      function o(e, n) {
        ...
        for (
          var o = Y.find('[data-bs-toggle="collapse"]'), r = 0, s = o.length;
          r < s;
          r++
        ) {
          var a = o[r],
  ...
  function Dt(t) {
    ...
    if (l) {
      ...
      v === ut(n) && (v = bt(n)),
        o === et &&
          ((g = nt), (f -= v.clientHeight - i.height), (f *= a ? 1 : -1)),
        o === ot &&
          ((p = it), (u -= v.clientWidth - i.width), (u *= a ? 1 : -1));
    }
    var _,
            ...
            return (
              (t[n] = (function (t, e, n) {
                ...
                return (
                  (s = s || 0),
                  (a = (a || 0) * o),
                  [ot, it].indexOf(i) >= 0 ? { x: a, y: s } : { x: s, y: a }
                );
              })(n, e.rects, r)),
              t
            );
      ...
      return (
        ...
        (r.hide = function () {
          if (
            ...
            var t = o.getParentFromElement(this._element),
              e = { relatedTarget: this._element };
            B.trigger(t, "hide.bs.dropdown", e).defaultPrevented ||
                ...
                if (
                  ...
                  !(
                    (t &&
                      ...
                      c.contains(t.target)) ||
                    B.trigger(r, "hide.bs.dropdown", a).defaultPrevented
                  )
                )
                  "ontouchstart" in document.documentElement &&
                    (l = []).concat
          ...
          l.forEach(function (t) {
            (function (t, e) {
              ...
              if (e.includes(n))
                return (
                  !Ee.has(n) ||
                  Boolean(t.nodeValue.match(Te) || t.nodeValue.match(ke))
                );
              for (
      ...
      return (
        ...
        (r._getConfig = function (t) {
          ...
          return (
            ...
            p(Le, t, this.constructor.DefaultType),
            t.sanitize &&
              (t.template = Oe(t.template, t.allowList, t.sanitizeFn)),
            t
          );
        }),
    ...
    Ue = (function (t) {
      ...
      return (
        ...
        (r._getConfig = function (t) {
          if (
            "string" !=
              typeof (t = n({}, Ke, "object" == typeof t && t ? t : {}))
                .target &&
            d(t.target)
          ) {
            var e = t.target.id;
